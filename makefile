...
ifndef EEBASE
        EEBASE := $(shell cygpath `cygpath -ms 'C:\EmbeddedSystems\Software\EE_RTwin32-x86_64\eclipse\plugins\com.eu.evidence.ee_2.5.0.20150528_0935\ee_files'`)
else
...
#
############################################################################
APP_SRCS += eecfg.c code.c Touch.c pictures.c Watch.c Event.c Widget.c WidgetConfig.c SW_wrapper.c STMPE811QTR.c debug.c
